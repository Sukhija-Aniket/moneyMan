...
class OAuthToken(Base):
    ...
    # Phase 1: encrypted with Fernet (see services/token_crypto.py) as a stand-in for
    # the Cloud KMS envelope encryption described in the architecture plan for production.
